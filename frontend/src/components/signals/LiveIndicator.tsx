...
export function LiveIndicator({ connected, lastUpdate }: Props) {
  return (
    <div className="flex items-center gap-2.5 px-3.5 py-2 rounded-xl glass-card shadow-glass text-xs">
      {connected ? (
        <>
          ...
          <span className="font-mono font-semibold text-success tracking-wide">LIVE</span>
