...
export default function OpportunityDetail() {
  ...
  if (!signal) {
    return (
      <div className="py-16 text-center">
        ...
        <Link to="/opportunities" className="mt-4 inline-block text-accent">
  ...
  return (
    <div className="max-w-[900px]">
      <Link to="/opportunities" className="inline-flex items-center gap-1.5 text-sm text-txt-muted hover:text-txt-secondary mb-5 no-underline">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-xl md:text-2xl font-bold text-txt-primary tracking-tight leading-snug">
      ...
      >
        ...
        {signal.event && (
          <Card className="border-l-2 border-l-accent">
            <h4 className="text-xs font-semibold text-txt-muted uppercase tracking-wider mb-3">The Story</h4>
        ...
        <Card>
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="w-full md:w-56 shrink-0">
              <p className="text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-2">Conviction Score</p>
              <ScoreBar
            ...
            <div className="flex-1">
              <p className="text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-2">Position</p>
              <div className="flex gap-2 flex-wrap mb-4">
                ...
                {edge.label !== "N/A" && (
                  <span
                    className="inline-flex items-center gap-1 text-xs font-bold uppercase px-2 py-1 rounded"
                    style={{
                      color: edge.color,
        ...
        {signal.signal_strength != null && signal.trade_quality != null && (
          <Card>
            <h4 className="text-xs font-semibold text-txt-muted uppercase tracking-wider mb-4">Score Breakdown</h4>
        ...
        {signal.analysis && (
          <Card>
            <h4 className="text-xs font-semibold text-txt-muted uppercase tracking-wider mb-4 flex items-center gap-2">
            ...
            {(signal.analysis.impact_strength != null || signal.analysis.llm_confidence != null) && (
              <div className="flex gap-4 mt-4 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        {(signal.score_explanation || signal.yes_probability_explanation) && (
          <Card className="border-l-2 border-l-accent/40">
            {signal.score_explanation && (
              <div className="mb-3">
                <h4 className="text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-1.5">Why This Score</h4>
                <p className="text-sm text-txt-secondary leading-relaxed">{signal.score_explanation}</p>
              </div>
            )}
            {signal.yes_probability_explanation && (
              <div>
                <h4 className="text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-1.5">Market Context</h4>
        ...
        {signal.outcome && (
          <Card>
            <h4 className="text-xs font-semibold text-txt-muted uppercase tracking-wider mb-4">Result</h4>
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
              ...
              <div>
                <span className="block text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-1">Won?</span>
...
function MetricBox({ label, value, color }: { label: string; value: string; color?: string }) {
  return (
    <Card className="p-4">
      <span className="block text-[11px] font-semibold text-txt-muted uppercase tracking-wider mb-1">{label}</span>
