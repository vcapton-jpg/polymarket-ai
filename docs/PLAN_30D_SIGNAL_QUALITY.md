...
| ⬜ J14 (2026-05-18) | **H+168 v2 — décider flip T-013** | Lancer `check_v2_rollout.py --hours 168` + re-run la cross-tab BUY_NO × prix × `llm_model_version`. Si v2 a tué le bucket toxique → T-013 reste OFF. Sinon → flip. |
